-- ============================================================
-- Weekly Wins RLS Hardening — enforce rep-ownership for edits (F45 / #1224)
...
-- ============================================================
-- Prevents a signed-in user from inserting/updating a wins row for a rep that
-- isn't theirs (the client-side canEdit gate in wins-form.jsx is the first line;
...
--
-- Read/Delete are intentionally left unchanged here (out of F45 scope). Note:
-- "anyone can delete wins" is still permissive — harden separately if reps
-- shouldn't delete.
